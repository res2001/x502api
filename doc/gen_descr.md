...
==============================================================
  ...
  4. В связи с ограничением скорости передачи в E502 поддерживается возможность задать общий делитель для частоты вывода (в L502 вывод всегда осуществляется на частоте равной половине опорной частоты), который можно задать с помощью X502_SetOutFreqDivider() или X502_SetOutFreq().
