...
\begin{document}
  ...
  1.1.4            & 29.06.2016    &  Добавлено описание функций X502\_CheckFeature() и X502\_OutGetStatusFlags(). Указано, что установка частоты вывода доступна и в L502, начиная с версии 0.5 прошивки ПЛИС \\\hline
  \end{longtable}
  \newpage  
