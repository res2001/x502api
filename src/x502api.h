...
/***************************************************************************//**
    ...
    Создание описателя модуля, для последующей работы с модулем X502.
...
/***************************************************************************//**
    ...
    Функция разрывает соединение с модулем X502, если оно было ранее установлено
...
/***************************************************************************//**
    ...
    @note Данная функция поддерживается в L502 только для версии прошивки ПЛИС
          0.6 и выше и всегда поддерживается для E502
...
/***************************************************************************//**
    ...
    буфер в драйвере или билиотеке.
...
/***************************************************************************//**
    ...
    обработаному последующим вызовом X502_ProcessData().
...
/***************************************************************************//**
    ...
    и точная точка останова неизвествна.
...
/***************************************************************************//**
   @brief Установка подтягивающих резисторов на входных линиях.
    ...
    цифровых входах. Для разных модулей подтягивающие резистроы реализованы
    на разных входах. Для всех модулей можно влючать их на линиях SYN1 и SYN2.
