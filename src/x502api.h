...
typedef enum {
    ...
    X502_DEVFLAGS_IFACE_SUPPORT_PCI     = 0x00000100,
    /** Признак, что устройство поддерживает интерфейс USB */
    X502_DEVFLAGS_IFACE_SUPPORT_USB     = 0x00000200,
    /** Признак, что устройство поддерживает Ethernet */
    X502_DEVFLAGS_IFACE_SUPPORT_ETH     = 0x00000400,
...
/***************************************************************************//**
    ...
    и точная точка останова не извествна.
